        ...
        <div class="form-box">
            ...
            <form id="profile-form" class="profile-form" action="profile-db.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="national_id" name="national_id" value="<?php echo $national_id; ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="marital_status">Marital Status:</label>
                    <input type="text" id="marital_status" name="marital_status" value="<?php echo $marital_status; ?>" readonly>
                </div>
                <div class="form-group">
