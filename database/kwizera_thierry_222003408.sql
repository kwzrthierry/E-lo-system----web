...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2024 at 04:56 PM
...
--
-- Database: `kwizera_thierry_222003408`
--
...
CREATE TABLE `citizen` (
  ...
  `birth_date` varchar(120) DEFAULT NULL,
...
INSERT INTO `citizen` (`citizen_id`, `first_name`, `last_name`, `phone_number`, `email`, `birth_date`, `national_id`, `address`, `marital_status`, `sex`) VALUES
(1, 'thierry', 'kwizera', '098765432', 'kwizzo@gmail.com', '1990-01-15', '123456789', '123 Main St', 'Single', 'male'),
(2, 'shyaka', 'crispin', NULL, 'crspin@gmail.com', '2001-11-05', '1200280092619041', NULL, 'single', 'male'),
(3, 'beni', 'yakini', NULL, 'beni@gmaiil.com', '2002-03-05', '123456789012345', NULL, 'single', 'male');
...
(3, NULL, 1, 303, '2024-04-30'),
(4, NULL, 1, 304, '2024-04-30');
...
(301, 1, 101, 'asking for single certificate', '2023-08-15', 'processing', 'sent '),
(302, 1, NULL, 'change name', '2024-02-18', 'processing', 'done'),
(303, 1, NULL, 'type1', '2024-04-30', NULL, NULL),
(304, 1, NULL, 'Request land mitation services', '2024-04-30', NULL, NULL);
...
(102, 'Joanna', 'uwitonze', '07293449949', 'joann@gmail.com', 'officer');
...
--
ALTER TABLE `login_citizen`
  MODIFY `Login_citizen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `requests`
  MODIFY `Request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=305;
